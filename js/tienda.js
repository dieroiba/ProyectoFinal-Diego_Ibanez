...
const articulos = [
...

    {
        ...
        nombre: "Foto_3" ,
        precio: 389.99,
        imgSrc: "./img/arreglo/_EVP4617-Editar.jpg",
        stock: 5,
    },
];
...
function renderArticulos(){
    articulos.forEach((articulo) => {
        articulosEl.innerHTML += `
                <div>
                    <span class="item-titulo">${articulo.nombre}</span>
                    <img class= "item-imagen" src="${articulo.imgSrc}">
                        <div class="pie-foto">
...
function agregarAlCarrito (id) {
    ...
    verCarrito.innerHTML = "Hello Button";
        ...
        <div  class="carro-items"> 
            <div class = "fila-de-carro">
                <div class="carro-item carro-columna">
                    ...
                    <span class="carro-item-titulo">${item.nombre}</span>
                </div>
